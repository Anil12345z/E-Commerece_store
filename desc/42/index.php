...
<!-- Mirrored from www.vrjmetalhub.com/desc/42/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:26 GMT -->
        ...
        <div class="main-container">
          <div class="wrapper">
            <div class="container1">
              <img src="../../media/allProducts/Group_24.jpg">
            </div>
          </div>
          <div class="wrapper1">
            <div class="container2">
              <h2>Multi Expressions Buddha Paper Weight</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">VRJ METAL HUB Brass Multi Expressions Buddha Paper Weight for expressive look to your office space decor . Buddha taught the world about harmonious coexistence. In this brass figurine of buddha. You may alternatively order this masterpiece to use as table tops area, centerpiece for coffee table.</div>
                </div>
