...
<!-- Mirrored from www.vrjmetalhub.com/desc/36/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:23 GMT -->
        ...
        <div class="main-container">
          <div class="wrapper">
            <div class="container1">
              <img src="../../media/allProducts/52.jpg">
            </div>
          </div>
          <div class="wrapper1">
            <div class="container2">
              <h2>Kamadhenu Cow and Calf Brass Showpiece</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <span><h4>Dimensions:</h4> <p>‎10 CM X 5.5 CM X 7 CM</p></span>
                    <span><h4>Shipping Weight:</h4> <p>0.5 Kilograms</p></span>
                    <span><h4>Material</h4> <p>Brass</p></span>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Kamdhenu is the sacred wish-cow that grants all your wishes and desires. Kamdhenu cow is the mother of divine qualities and on earth it is equivalent of Goddess. Kamdhenu cow idol along with its calf is the symbol of prosperity and Vatsalya (love that a mother feels for a child).</div>
                </div>
