...
<!-- Mirrored from www.vrjmetalhub.com/desc/38/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:23 GMT -->
        ...
        <div class="main-container">
          <div class="wrapper">
            <div class="container1">
              <img src="../../media/allProducts/42.jpg">
            </div>
          </div>
          <div class="wrapper1">
            <div class="container2">
              <h2>Temple Brass Bell for Worship Copper Antique</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <span><h4>Color:</h4> <p>Copper Antique</p></span>
                    <span><h4>Dimensions:</h4> <p>12 x 12 x 12 cm</p></span>
                    <span><h4>Shipping Weight:</h4> <p>490 g</p></span>
                    <span><h4>Material</h4> <p>Brass</p></span>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Temples generally have one metal bell hanging at the entrance and devotees ring the bell while entering the temple which is an essential part in preparation.Sanskrit: घण्टा, IAST: ghaṇṭā; Tibetan: drilbu is the Sanskrit term for a ritual bell used in Hinduistic religious practices.</div>
                </div>
