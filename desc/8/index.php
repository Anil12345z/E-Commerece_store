...
<!-- Mirrored from www.vrjmetalhub.com/desc/8/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:26 GMT -->
        ...
        <div class="main-container">
          ...
          <div class="wrapper1">
            <div class="container2">
              <h2>Tusk Style Ganesha Carving Brass Door Handle Pair</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <span><h4>Color:</h4> <p>Multi</p></span>
                    <span><h4>Dimensions:</h4> <p>‎5 CM X 5 CM X 28 CM</p></span>
                    <span><h4>Shipping Weight:</h4> <p>‎1.4 Kilograms</p></span>
                    <span><h4>Material</h4> <p>Brass</p></span>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">This tusk style Ganesha carving handle- set of two from the house of will add grace and elegance to your door. It will invite instant attention with their minute carving and elegant design. This handicraft item is made of brass from the brand which pioneers in crafting brass creation with precision</div>
                </div>
