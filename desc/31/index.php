...
<!-- Mirrored from www.vrjmetalhub.com/desc/31/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:26 GMT -->
        ...
        <div class="main-container">
          ...
          <div class="wrapper1">
            <div class="container2">
              <h2>Shubh Labh with Bells Door &amp; Wall Hanging (Yellow Antique)</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <span><h4>Color:</h4> <p>Yellow Antique</p></span>
                    <span><h4>Dimensions:</h4> <p>‎9 CM X 3 CM X 16 CM</p></span>
                    <span><h4>Shipping Weight:</h4> <p>0.4 Kilograms</p></span>
                    <span><h4>Material</h4> <p>Brass</p></span>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Material and Finish These traditionally designed door hanging bells are made of pure brass. Brass is a material which lends itself most easily to use in artefacts meant for home decoration. Its durability and lasting looks ensure that the articles you choose for your home stay new for years.</div>
                </div>
