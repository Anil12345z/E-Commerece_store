...
<!-- Mirrored from www.vrjmetalhub.com/desc/9/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:36:01 GMT -->
        ...
        <div class="main-container">
          ...
          <div class="wrapper1">
            <div class="container2">
              <h2>Leaf Design Brass Door Handle Set</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <span><h4>Dimensions:</h4> <p>‎4.2 CM X 4.2 CM X 30 CM</p></span>
                    <span><h4>Shipping Weight:</h4> <p>‎1 Kilograms</p></span>
                    <span><h4>Material</h4> <p>Brass</p></span>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Made from high quality brass this Leaf Design Brass Door Handle Set ( C ) can be a decorative at the main door or gate of your house. Brass has several characteristics that make it ideal choice for art and craft, Designed smartly and skillfully to suit any kind of door, this door handle is a perfect</div>
                </div>
