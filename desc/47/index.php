...
<!-- Mirrored from www.vrjmetalhub.com/desc/47/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:22 GMT -->
        ...
        <div class="main-container">
          ...
          <div class="wrapper1">
            <div class="container2">
              <h2>Ethnic Indian Elephant Design Brass Urli (Antique Yellow, Standard)</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <span><h4>Dimensions:</h4> <p>34.4 x 22.1 x 22 cm</p></span>
                    <span><h4>Shipping Weight:</h4> <p>3.78 Kg</p></span>
                    <span><h4>Material</h4> <p>Brass</p></span>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Easily recognizable by its distinctive shape, the urli makes a handsome addition to the decor of any room. Now, you can enjoy the beauty of one that is made according to the time-honored traditions in your own home with the Handmade Brass Ganesh Urli. Produced using sand casting techniques that have</div>
                </div>
