...
<!-- Mirrored from www.vrjmetalhub.com/desc/41/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:26 GMT -->
        ...
        <div class="main-container">
          <div class="wrapper">
            <div class="container1">
              <img src="../../media/allProducts/Group_7.jpg">
            </div>
          </div>
          <div class="wrapper1">
            <div class="container2">
              <h2>God Tirupati Balaji Idol Showpiece Hindu Religious Sri Venkateswara Statue</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <span><h4>Color:</h4> <p>na</p></span>
                    <span><h4>Dimensions:</h4> <p>14 x 7.6 x 24.1 Centimeters</p></span>
                    <span><h4>Shipping Weight:</h4> <p>260g</p></span>
                    <span><h4>Material</h4> <p>Brass</p></span>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Trirupati Balaji is revered in Hinduism as a deity who exudes power and protects from all negative energies. He is worshiped as the living God, who is believed to exist even today. This product made of Metal and Beautiful work to make the figure look as real. It is a wonderful item for decoration at</div>
                </div>
