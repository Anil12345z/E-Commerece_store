...
<!-- Mirrored from www.vrjmetalhub.com/desc/22/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:17 GMT -->
...
<header id="header-container">
        ...
        <div class="main-container">
          ...
          <div class="wrapper1">
            <div class="container2">
              <h2>Dancing Ganesha Brass Pooja Spoon</h2>
              <div class="desc-box">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <span><h4>Color:</h4> <p>Antique</p></span>
                    <span><h4>Dimensions:</h4> <p>‎24.5 CM X 6.5 CM X 3 CM</p></span>
                    <span><h4>Shipping Weight:</h4> <p>‎0.36 Kilograms</p></span>
                    <span><h4>Material</h4> <p>Brass</p></span>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Prayer time will be special when you include Dancing Ganesha Brass Pooja Spoon . This eye-catching aarti spoon has beautiful carvings that add to its overall charm. Antique in color, this Pooja spoon is made of brass. It has a long handle that offers easy handling. Easy to maintain and long lasting,</div>
                </div>
    
              </div>
              <a href="../../contact.php"><button id="enquiry">Enquiry</button></a>
            </div>
          </div>
        </div>
    ...
    <footer>
       <div class="content"style="background-color:white">
          <div class="left box">
            <div class="lower">
              <div class="footertopic" style="font-weight:normal;">CONTACT US</div>
<div class="phone" style="margin-bottom: 4vh;"><h1 style="font-size: 1.6rem;color: #b8860b;">Phone</h1>
          ...
          <div class="middle box" >
            <div class="footertopic" style="font-weight:normal;">CATEGORIES</div>
...
<!-- Mirrored from www.vrjmetalhub.com/desc/22/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 16:34:22 GMT -->
</html>